...
public class LamentoEvento : Evento
{
    public LamentoEvento(Image imagenEvento, Image objectIcon)
    {
        ...
        _avisoQuitarObj = "Por fin en un lugar seguro, contempláis la opción de dejar a la jardinera aquí. Perderéis" +
            " su compañía, pero prometió recompensaros con unos deliciosos calabacines.";
        _eventoTxt = "Avanzáis por la cueva siguiendo las marcas dejados por otros aventureros, " +
            "en una de las cavernas por las que pasáis, escucháis un murmullo, casi un lamento, " +
            "proveniente de detrás de una piedra...";
        ...
        _resultadosList.Add("3. Estáis un rato pensado que hacer, no tenéis ni el tiempo ni los recursos para " +
            "desentrañar el misterio tras la pesada roca, decidís no darle importancia y seguir con vuestro camino. " +
            "El misterio no resuelto deja una mala sensación en el equipo. [-20 energía]");
    }

    private bool part2 = false;
    private string eventoTxt2 = "Una vez habéis apartado la roca del medio, veis de dónde proviene el misterioso" +
    ...
    private string p2res1 = "Dr. Jáparo se pone manos a la obra, sus 7 años de estudios no son moco de pavo, en un" +
        " pis pas, la aventurera está sanada y con fuerzas para seguir el camino. Extremadamente agradecida, " +
    ...
    private string p2res2 = "No tenéis los conocimientos médicos suficientes para curarla, sin embargo, fieles al " +
        ...
        "Agradecida por salvarle la vida, os regala unos exquisitos calabacines. [+60 energía, +15 oro]";
    private string p2res3 = "No podéis abandonar a una persona en apuros, decidís cargarla hasta un lugar más seguro." +
        " Cargar con ella os costará más energía, sin embargo, una vez recupera la conciencia descubrís que es una " +
