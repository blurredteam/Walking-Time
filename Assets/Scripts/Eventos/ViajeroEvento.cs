...
public class ViajeroEvento : Evento
{
    public ViajeroEvento(Image imagenEvento)
    {
        ...
        _eventoTxt = "Durante tu aventura os encontráis a un hombre tumbado en el suelo, muy debilitado. Cuándo os acercáis el hombre habla tosiendo y con una voz grave:\r\n– Agua, por favor… Agua.";
        ...
        _resultadosList.Add("Te acercas al hombre, aún tumbado, para ver si podéis\r\nconseguir algo de valor. Encuentras unas monedas, pero el\r\nhombre se retuerce cuando las intentas coger, haciéndote\r\ncaer al suelo. Te levantas magullado y os vais, siguiendo\r\ncon vuestra aventura.\r\n");
        _resultadosList.Add("Ignorais al hombre y seguis el sendero, no todos estan de acuerdo con esta decisión, pero sabes que vuestros recursos son limitados. El abondono del hombre deja una mala sensación sobre los miembros del equipo... [-15 energía]");
    }
